  ...
  return (
    <>
      <Card
        ...
        className="flex gap-4 p-3 rounded-2xl bg-white/90 items-start h-[130px] md:h-[150px] lg:h-[155px] cursor-pointer"
      ...
      >
        ...
        <div className="flex flex-col flex-1 h-full justify-between">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="text-sm font-bold text-black border border-gray-300 rounded-lg px-2 py-1 hover:bg-gray-100 transition cursor-pointer">
              Add To Cart
            </button>
          </div>
        </div>
